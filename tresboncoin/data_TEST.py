...
from tresboncoin.utils_TEST import sent_file_to_bucket
...
history_data_gs = "gs://tresboncoin/master_with_fuzzy_and_cleaning.csv"
#
...
#
    ...
    sent_file_to_bucket(raw_data_local, "master_data.csv")

    print(colored("Concat dataset saved as master/master_data.csv. Shape: " + str(data.shape), "green"))
    print(colored("Concat dataset saved to bucket: " + str(data.shape), "green"))
...
def append(new_data_matched, history_data):
    ...
    sent_file_to_bucket(history_data_local, "master_with_fuzzy_and_cleaning.csv")
    return new_history
